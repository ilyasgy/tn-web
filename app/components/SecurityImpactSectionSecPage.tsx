        ...
        <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-6">
          <div className="max-w-2xl">
            ...
            <h2 className="mt-4 text-3xl md:text-4xl font-bold leading-[1.12] text-white">
              Automated traffic hits every public endpoint.
            </h2>

            <p className="mt-4 text-white/55 md:text-lg">
              Most web threats aren't personal; they’re automated scans.
              Bots crawl the network 24/7 looking for common misconfigurations and unpatched headers,
              regardless of a site's size or popularity.
            </p>
          </div>
          ...
          <div className="rounded-[28px] border border-white/10 bg-black/70 p-7 md:p-8">
            ...
            <div className="mt-7 rounded-2xl border border-white/10 bg-black/60 p-5">
              ...
              <p className="mt-2 text-sm text-white/55 leading-relaxed">
                Our security check identifies and patches the gaps automated bots look for.
                We deliver a concise breakdown of actionable fixes that harden your site without slowing down your workflow or your launch.
              </p>
            </div>
          </div>
